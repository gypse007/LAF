...
export default function ManifestoSection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.to('.manifesto-word', {
        y: -10, duration: 2, ease: 'sine.inOut',
  ...
  return (
    ...
    >
      {/* Background gradient orbs — gold */}
      <div className="absolute top-1/4 left-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-[#C9A962]/10 rounded-full blur-[80px] sm:blur-[120px]" />
      <div className="absolute bottom-1/4 right-1/4 w-40 h-40 sm:w-80 sm:h-80 bg-[#C9A962]/5 rounded-full blur-[60px] sm:blur-[100px]" />

      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
        <div className="space-y-2 sm:space-y-4 mb-10 sm:mb-16">
          <div ref={line1Ref} className="manifesto-word">
            <span className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-[#C9A962] via-[#E8D5A3] to-[#C9A962]">
              DESIGN
            </span>
          </div>
          ...
          <div ref={line3Ref} className="manifesto-word">
            <span className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-[#E8D5A3] via-[#C9A962] to-[#9A7B3D]">
              PERFECTION
            </span>
          </div>
        </div>
        ...
        >
          At Lakshmi Art Fixers, we don't just paint walls. We transform spaces into
          <span className="text-[#C9A962]"> living art</span>. Every stroke is calculated,
        ...
        <div className="mt-10 sm:mt-16 flex items-center justify-center gap-4">
          <div className="w-16 sm:w-24 h-px bg-gradient-to-r from-transparent to-[#C9A962]/50" />
          <div className="w-2 h-2 sm:w-3 sm:h-3 rotate-45 border border-[#C9A962]/50" />
          <div className="w-16 sm:w-24 h-px bg-gradient-to-l from-transparent to-[#C9A962]/50" />
        </div>
      </div>
    </section>
  );
