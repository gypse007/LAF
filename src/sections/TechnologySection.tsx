...
export default function TechnologySection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-0 w-48 h-48 sm:w-96 sm:h-96 bg-[#C9A962]/5 rounded-full blur-[80px] sm:blur-[150px] -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-40 h-40 sm:w-80 sm:h-80 bg-[#C9A962]/5 rounded-full blur-[60px] sm:blur-[120px]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center mb-12 sm:mb-20">
          ...
          <div ref={contentRef}>
            <div className="space-y-4 sm:space-y-6">
              <p className="text-lg sm:text-xl text-white/80 leading-relaxed">
                Our state-of-the-art <span className="text-[#C9A962]">vertical printing robots</span> bring unprecedented precision and scale to wall artistry. This isn't just painting—it's engineering meets art.
              </p>
            ...
            <div className="mt-8 sm:mt-10 grid grid-cols-2 gap-3 sm:gap-4">
              <div className="p-3 sm:p-4 rounded-xl border border-[#C9A962]/20 bg-[#C9A962]/5">
                <div className="text-2xl sm:text-3xl font-bold text-[#C9A962] mb-1">20ft</div>
                <div className="text-xs sm:text-sm text-white/50">Max Height</div>
              </div>
              <div className="p-3 sm:p-4 rounded-xl border border-[#C9A962]/20 bg-[#C9A962]/5">
                <div className="text-2xl sm:text-3xl font-bold text-[#C9A962] mb-1">1440</div>
          ...
          <div className="relative">
            <div className="relative aspect-square rounded-xl sm:rounded-2xl overflow-hidden border border-[#C9A962]/20 bg-black">
              <video
              ...
              {/* Floating Badge */}
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 p-3 sm:p-4 rounded-xl border border-[#C9A962]/30 bg-black/60 backdrop-blur-xl">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#C9A962] flex items-center justify-center flex-shrink-0">
            ...
            {/* Decorative Elements */}
            <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 w-16 sm:w-24 h-16 sm:h-24 border border-[#C9A962]/30 rounded-lg sm:rounded-xl" />
            <div className="absolute -bottom-3 -left-3 sm:-bottom-4 sm:-left-4 w-20 sm:w-32 h-20 sm:h-32 border border-[#C9A962]/20 rounded-lg sm:rounded-xl" />
          </div>
        </div>
        ...
        <div ref={featuresRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="tech-feature group p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm hover:border-[#C9A962]/30 hover:bg-[#C9A962]/5 transition-all duration-500"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-[#C9A962]/10 flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-[#C9A962] group-hover:text-black transition-all duration-500 text-[#C9A962]">
                  <Icon className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>

                <div className="text-2xl sm:text-3xl font-bold text-[#C9A962] mb-1">
                  {feature.stat}
                </div>
                ...
                <h3 className="text-base sm:text-lg font-bold text-white mb-1 sm:mb-2 group-hover:text-[#C9A962] transition-colors">
                  {feature.title}
                </h3>
